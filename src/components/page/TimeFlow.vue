    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item> <i class="el-icon-lx-cascades"></i> 诊断流程-时间流 </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="conditionParam.patientId" placeholder="输入被试（患者）id" class="handle-input mr10"></el-input>
